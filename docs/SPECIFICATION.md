...
| 📐 **正三角形 (Triangle)** | ネオンオレンジ | `#ff9900` | `spiral` (旋回) |
| 🔷 **ひし形 (Diamond)** | ネオンシアン | `#00ffcc` | `wave` (波状運動) |
| 🪃 **L字ポリゴン (L-Shape)** | ネオンピンク | `#ff0077` | `boomerang` (引き返し回転) |
| 🌟 **4角手裏剣 (Ghost)** | ネオンライム | `#aaff66` | `stealth` (隠密・透明化) |
| ⬢ **正六角形 (Hexagon)** | ネオンアイスブルー | `#00ccff` | `freeze` (一瞬停止) |
| 🪐 **惑星サターン土星輪 (Ring)** | ネオンゴールド | `#ffea00` | `orbit` (360度公転) |
| ⬠ **正五角形 (Pentagon)** | ネオングリーン | `#00ff66` | `bound` (屈折バウンド) |
